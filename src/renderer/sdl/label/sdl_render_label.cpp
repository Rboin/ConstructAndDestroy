...
SDLRenderLabel::SDLRenderLabel(const vec2 &position, const vec2 &size, sdl_data *data, std::string image_path, const char *text, TTF_Font *font) : SDL_RenderObject(position,
                                                                                                          size, data) {
    ...
    sdl_text *text_data = new sdl_text{_data->red, _data->green, _data->blue, text, font};
