...
MercenaryEntity::MercenaryEntity(vec2 position, float mass) :
    ...
    max_force = 0.2;
    max_speed = 0.1;
    _attack_damage = 20 * UpgradeManager::get_instance()->extra_damage;
    _max_health = 50 * UpgradeManager::get_instance()->extra_hp;
    _health = 50 * UpgradeManager::get_instance()->extra_hp;
