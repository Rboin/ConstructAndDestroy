...
LightCavalierEntity::LightCavalierEntity(vec2 position, float mass) :
    ...
    max_force = 0.2;
    max_speed = 0.2;
    _attack_damage = 5 * UpgradeManager::get_instance()->extra_damage;
    _max_health = 150 * UpgradeManager::get_instance()->extra_hp;
    _health = 150 * UpgradeManager::get_instance()->extra_hp;
