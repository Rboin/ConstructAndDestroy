...
#ifndef C_AND_D_PROJECT_FUZZY_SET_RIGHT_SHOULDER_H
#define C_AND_D_PROJECT_FUZZY_SET_RIGHT_SHOULDER_H
...
public:
    ...
    FuzzySetRightShoulder(double peak,
                           double _left_off_set,
                           double _right_off_set):

            FuzzySet( ((peak + _right_off_set) + peak) / 2),
            _peak_point(peak),
...
#endif //C_AND_D_PROJECT_FUZZY_SET_RIGHT_SHOULDER_H
